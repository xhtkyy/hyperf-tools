...
namespace Xhtkyy\HyperfTools\Grpc\Health\HealthCheckResponse;
...
class_alias(ServingStatus::class, \Xhtkyy\HyperfTools\Grpc\Health\HealthCheckResponse_ServingStatus::class);
